...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-[#808080a9] bg-opacity-50 z-[98]"
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-[600px] max-w-full bg-white shadow-xl z-[99] transform transition-transform duration-300 ${
